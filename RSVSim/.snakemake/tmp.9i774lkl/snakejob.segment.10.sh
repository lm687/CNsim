...
--wait-for-files /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.9i774lkl output/output_genome2/alignments/aligned_sim_transloc_reads316dbcd5-2e0c-4976-9fe2-c05bce116c0f_nreads12000_sizedels1000.bam --latency-wait 5 \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.9i774lkl/10.jobfinished || (touch /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.9i774lkl/10.jobfailed; exit 1)
