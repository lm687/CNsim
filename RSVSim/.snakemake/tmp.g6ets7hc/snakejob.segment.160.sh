...
--wait-for-files /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.g6ets7hc output/output_genome2/alignments/aligned_sim_transloc_reads60f5571d-95d2-4278-b97d-89a6ab812a7a_nreads12000_sizedels1000.bam --latency-wait 5 \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.g6ets7hc/160.jobfinished || (touch /rds/user/lm687/hpc-work/CNsim/RSVSim/.snakemake/tmp.g6ets7hc/160.jobfailed; exit 1)
